  ...
  return (
    <div className="main">
      <div className="login">
        ...
        <input type="text" placeholder="Escribe aqui tu email" onChange={habdleCheckName}/>
        <input type="password" placeholder="Escribe aquí tu contraseña" onChange={handleCheckPass}/>
        <div className="checkbox">
          <input type="checkbox" name="checkbox" id="checkbox"/>
          <label htmlFor="checkbox">Keep me signed in</label>
        </div>
        <div className="botones">
          <button onClick={checkUser} type="button">Log-In</button>
